...
class LiteBackendStrings
{
    ...
    public static function getAllStrings()
    {
        return [
            ...
            'service_show_on_site'                             => __('Show on website', 'wpamelia'),
            'service_show_on_site_tooltip'                     => __('If this option is disabled, the service will be bookable only from the back end.', 'wpamelia'),
            ...
            'event_show_on_site'                               => __('Show on website', 'wpamelia'),
