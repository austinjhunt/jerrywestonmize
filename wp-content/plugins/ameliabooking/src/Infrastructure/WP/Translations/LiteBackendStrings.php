...
class LiteBackendStrings
{
    ...
    public static function getAllStrings()
    {
        return [
            ...
            'backup_before_import_warning'                     => __('Please back up before proceeding to avoid loss of data.', 'wpamelia'),
            'automatically_create_event_page_for_new_events'   => __('Automatically create an Event Page for new events', 'wpamelia'),
            ...
            'wpa_events_cpt_new_item'                          => __('New Event Page', 'wpamelia'),
            'wpa_events_cpt_view_item'                         => __('View Event Page', 'wpamelia'),
            'wpa_events_cpt_search_items'                      => __('Search Event Pages', 'wpamelia'),
            ...
            'import_overwrite_warning'                         => __('I understand this import will replace all current data permanently.', 'wpamelia'),
            'data_transfer'                                    => __('Data transfer', 'wpamelia'),
            'export_amelia_data_description'                   => __('This export includes, but is not limited to, bookings, customers, settings, notification logs, and SMS history. Site-specific data (such as URLs, images, and purchase codes) is excluded and must be set up manually on a new site.', 'wpamelia'),
            'export_data'                                      => __('Export data', 'wpamelia'),
            'import_data'                                      => __('Import data', 'wpamelia'),
            'export_failed'                                    => __('Export failed.', 'wpamelia'),
            'data_export_ready'                                => __('Data export is ready.', 'wpamelia'),
            'do_not_exit_import_until_finished'                => __('Do not exit the import until it is finished.', 'wpamelia'),
            'import_completed_successfully'                    => __('Import completed successfully.', 'wpamelia'),
            'import_failed_review_details'                     => __('Import failed. Review the details below.', 'wpamelia'),
            'import_progress'                                  => __('Import progress', 'wpamelia'),
            'import_errors'                                    => __('Import errors', 'wpamelia'),
            'import_completed'                                 => __('Import completed', 'wpamelia'),
            'import_failed'                                    => __('Import failed', 'wpamelia'),
            'all_entities_imported'                            => __('All entities imported', 'wpamelia'),
            'inserted'                                         => __('Inserted', 'wpamelia'),
            'skipped'                                          => __('Skipped', 'wpamelia'),
            'select_archive_before_import'                     => __('Select a .ameliafile archive before starting the import.', 'wpamelia'),
            'import_could_not_be_started'                      => __('Import could not be started.', 'wpamelia'),
            'import_started'                                   => __('Import started.', 'wpamelia'),
            'import_progress_could_not_be_updated'             => __('Import progress could not be updated.', 'wpamelia'),
            'importing_settings'                               => __('Importing settings', 'wpamelia'),
            'importing_locations'                              => __('Importing locations', 'wpamelia'),
            'importing_location_views'                         => __('Importing location view settings', 'wpamelia'),
            'importing_customers'                              => __('Importing customers', 'wpamelia'),
            'importing_employees'                              => __('Importing employees', 'wpamelia'),
            'importing_providers_views'                        => __('Importing employee views', 'wpamelia'),
            'importing_providers_outlook_calendar'             => __('Importing Outlook calendar sync', 'wpamelia'),
            'importing_providers_google_calendar'              => __('Importing Google calendar sync', 'wpamelia'),
            'importing_providers_locations'                    => __('Importing employee locations', 'wpamelia'),
            'importing_providers_week_days'                    => __('Importing work periods', 'wpamelia'),
            'importing_providers_days_off'                     => __('Importing days off', 'wpamelia'),
            'importing_providers_special_days'                 => __('Importing special days', 'wpamelia'),
            'importing_providers_time_out'                     => __('Importing time outs', 'wpamelia'),
            'importing_providers_periods'                      => __('Importing provider periods', 'wpamelia'),
            'importing_providers_special_day_periods'          => __('Importing provider special-day periods', 'wpamelia'),
            'importing_categories'                             => __('Importing categories', 'wpamelia'),
            'importing_services'                               => __('Importing services', 'wpamelia'),
            'importing_notifications'                          => __('Importing notifications', 'wpamelia'),
            'importing_services_views'                         => __('Importing service views', 'wpamelia'),
            'importing_providers_period_services'              => __('Importing period-service relations', 'wpamelia'),
            'importing_providers_period_locations'             => __('Importing period-location relations', 'wpamelia'),
            'importing_providers_special_day_period_services'  => __('Importing special-day period-service relations', 'wpamelia'),
            'importing_providers_special_day_period_locations' => __('Importing special-day period-location relations', 'wpamelia'),
            'importing_providers_services'                     => __('Importing employee services', 'wpamelia'),
            'importing_extras'                                 => __('Importing extras', 'wpamelia'),
            'importing_packages'                               => __('Importing packages', 'wpamelia'),
            'importing_coupons'                                => __('Importing coupons', 'wpamelia'),
            'importing_notifications_to_entities'              => __('Importing notification relations', 'wpamelia'),
            'importing_package_services'                       => __('Importing package services', 'wpamelia'),
            'importing_package_services_providers'             => __('Importing package service providers', 'wpamelia'),
            'importing_package_services_locations'             => __('Importing package service locations', 'wpamelia'),
            'importing_package_customers'                      => __('Importing package bookings', 'wpamelia'),
            'importing_package_customers_services'             => __('Importing package booking services', 'wpamelia'),
            'importing_resources'                              => __('Importing resources', 'wpamelia'),
            'importing_appointments'                           => __('Importing appointments', 'wpamelia'),
            'importing_events'                                 => __('Importing events', 'wpamelia'),
            'importing_resources_to_entities'                  => __('Importing resource relations', 'wpamelia'),
            'importing_events_tags'                            => __('Importing event tags', 'wpamelia'),
            'importing_events_tickets'                         => __('Importing event tickets', 'wpamelia'),
            'importing_events_periods'                         => __('Importing event periods', 'wpamelia'),
            'importing_events_providers'                       => __('Importing event providers', 'wpamelia'),
            'importing_customer_bookings'                      => __('Importing bookings', 'wpamelia'),
            'importing_customer_bookings_to_extras'            => __('Importing booking extras', 'wpamelia'),
            'importing_customer_bookings_to_events_periods'    => __('Importing event booking periods', 'wpamelia'),
            'importing_customer_bookings_to_events_tickets'    => __('Importing event booking tickets', 'wpamelia'),
            'importing_notifications_log'                      => __('Importing notification log', 'wpamelia'),
            'importing_notifications_sms_history'              => __('Importing notification SMS history', 'wpamelia'),
            'importing_payments'                               => __('Importing payments', 'wpamelia'),
            'importing_coupons_to_services'                    => __('Importing coupon-service relations', 'wpamelia'),
            'importing_coupons_to_events'                      => __('Importing coupon-event relations', 'wpamelia'),
            'importing_coupons_to_packages'                    => __('Importing coupon-package relations', 'wpamelia'),
            'importing_custom_fields'                          => __('Importing custom fields', 'wpamelia'),
            'importing_custom_fields_options'                  => __('Importing custom field options', 'wpamelia'),
            'importing_custom_fields_services'                 => __('Importing custom field services', 'wpamelia'),
            'importing_custom_fields_events'                   => __('Importing custom field events', 'wpamelia'),
            'importing_taxes'                                  => __('Importing taxes', 'wpamelia'),
            'importing_taxes_to_entities'                      => __('Importing tax relations', 'wpamelia'),
            'all'                                              => __('All', 'wpamelia'),
            ...
            'create_event_page'                                => __('Create event page', 'wpamelia'),
            'edit_event_page'                                  => __('Edit event page', 'wpamelia'),
            'red_event_wpa_custom_post_ready'                  => __('The custom post is ready.', 'wpamelia'),
