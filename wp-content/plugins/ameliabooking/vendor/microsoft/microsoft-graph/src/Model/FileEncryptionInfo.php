...
class FileEncryptionInfo extends Entity
{
    ...
    *
    * @return \AmeliaVendor\GuzzleHttp\Psr7\Stream|null The encryptionKey
    */
    public function getEncryptionKey()
    {
        if (array_key_exists("encryptionKey", $this->_propDict)) {
            if (is_a($this->_propDict["encryptionKey"], "\AmeliaVendor\GuzzleHttp\Psr7\Stream") || is_null($this->_propDict["encryptionKey"])) {
                return $this->_propDict["encryptionKey"];
            } else {
                $this->_propDict["encryptionKey"] = \AmeliaVendor\GuzzleHttp\Psr7\Utils::streamFor($this->_propDict["encryptionKey"]);
                return $this->_propDict["encryptionKey"];
            }
        }
        return null;
    ...
    * The key used to encrypt the file content.
    *
    * @param \AmeliaVendor\GuzzleHttp\Psr7\Stream $val The value to assign to the encryptionKey
    *
    ...
    *
    * @return \AmeliaVendor\GuzzleHttp\Psr7\Stream|null The fileDigest
    */
    public function getFileDigest()
    {
        if (array_key_exists("fileDigest", $this->_propDict)) {
            if (is_a($this->_propDict["fileDigest"], "\AmeliaVendor\GuzzleHttp\Psr7\Stream") || is_null($this->_propDict["fileDigest"])) {
                return $this->_propDict["fileDigest"];
            } else {
                $this->_propDict["fileDigest"] = \AmeliaVendor\GuzzleHttp\Psr7\Utils::streamFor($this->_propDict["fileDigest"]);
                return $this->_propDict["fileDigest"];
            }
        }
        return null;
    ...
    * The file digest prior to encryption.
    *
    * @param \AmeliaVendor\GuzzleHttp\Psr7\Stream $val The value to assign to the fileDigest
    *
    * @return FileEncryptionInfo The FileEncryptionInfo
    */
    ...
    *
    * @return \AmeliaVendor\GuzzleHttp\Psr7\Stream|null The initializationVector
    */
    public function getInitializationVector()
    {
        if (array_key_exists("initializationVector", $this->_propDict)) {
            if (is_a($this->_propDict["initializationVector"], "\AmeliaVendor\GuzzleHttp\Psr7\Stream") || is_null($this->_propDict["initializationVector"])) {
                return $this->_propDict["initializationVector"];
            } else {
                $this->_propDict["initializationVector"] = \AmeliaVendor\GuzzleHttp\Psr7\Utils::streamFor($this->_propDict["initializationVector"]);
                return $this->_propDict["initializationVector"];
            }
        }
        return null;
    ...
    * The initialization vector used for the encryption algorithm.
    *
    * @param \AmeliaVendor\GuzzleHttp\Psr7\Stream $val The value to assign to the initializationVector
    *
    * @return FileEncryptionInfo The FileEncryptionInfo
    */
    ...
    *
    * @return \AmeliaVendor\GuzzleHttp\Psr7\Stream|null The mac
    */
    public function getMac()
    {
        if (array_key_exists("mac", $this->_propDict)) {
            if (is_a($this->_propDict["mac"], "\AmeliaVendor\GuzzleHttp\Psr7\Stream") || is_null($this->_propDict["mac"])) {
                return $this->_propDict["mac"];
            } else {
                $this->_propDict["mac"] = \AmeliaVendor\GuzzleHttp\Psr7\Utils::streamFor($this->_propDict["mac"]);
                return $this->_propDict["mac"];
            }
        }
        return null;
    ...
    * The hash of the encrypted file content + IV (content hash).
    *
    * @param \AmeliaVendor\GuzzleHttp\Psr7\Stream $val The value to assign to the mac
    *
    * @return FileEncryptionInfo The FileEncryptionInfo
    */
    ...
    *
    * @return \AmeliaVendor\GuzzleHttp\Psr7\Stream|null The macKey
    */
    public function getMacKey()
    {
        if (array_key_exists("macKey", $this->_propDict)) {
            if (is_a($this->_propDict["macKey"], "\AmeliaVendor\GuzzleHttp\Psr7\Stream") || is_null($this->_propDict["macKey"])) {
                return $this->_propDict["macKey"];
            } else {
                $this->_propDict["macKey"] = \AmeliaVendor\GuzzleHttp\Psr7\Utils::streamFor($this->_propDict["macKey"]);
                return $this->_propDict["macKey"];
            }
        }
        return null;
    ...
    * The key used to get mac.
    *
    * @param \AmeliaVendor\GuzzleHttp\Psr7\Stream $val The value to assign to the macKey
    *
    * @return FileEncryptionInfo The FileEncryptionInfo
    */
