...
class OfficeClientConfiguration extends Entity
{
    ...
    *
    * @return \AmeliaGuzzleHttp\Psr7\Stream|null The policyPayload
    */
    public function getPolicyPayload()
    {
        if (array_key_exists("policyPayload", $this->_propDict)) {
            if (is_a($this->_propDict["policyPayload"], "\AmeliaGuzzleHttp\Psr7\Stream") || is_null($this->_propDict["policyPayload"])) {
                return $this->_propDict["policyPayload"];
            } else {
                $this->_propDict["policyPayload"] = \AmeliaGuzzleHttp\Psr7\Utils::streamFor($this->_propDict["policyPayload"]);
                return $this->_propDict["policyPayload"];
            }
        }
        return null;
    ...
    * Policy settings JSON string in binary format, these values cannot be changed by the user.
    *
    * @param \AmeliaGuzzleHttp\Psr7\Stream $val The policyPayload
    *
    * @return OfficeClientConfiguration
    */
    ...
    *
    * @return \AmeliaGuzzleHttp\Psr7\Stream|null The userPreferencePayload
    */
    public function getUserPreferencePayload()
    {
        if (array_key_exists("userPreferencePayload", $this->_propDict)) {
            if (is_a($this->_propDict["userPreferencePayload"], "\AmeliaGuzzleHttp\Psr7\Stream") || is_null($this->_propDict["userPreferencePayload"])) {
                return $this->_propDict["userPreferencePayload"];
            } else {
                $this->_propDict["userPreferencePayload"] = \AmeliaGuzzleHttp\Psr7\Utils::streamFor($this->_propDict["userPreferencePayload"]);
                return $this->_propDict["userPreferencePayload"];
            }
        }
        return null;
    ...
    * Preference settings JSON string in binary format, these values can be overridden by the user.
    *
    * @param \AmeliaGuzzleHttp\Psr7\Stream $val The userPreferencePayload
    *
    * @return OfficeClientConfiguration
    */
