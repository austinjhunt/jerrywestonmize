...
class DeviceCustomAttributeShellScript extends Entity
{
    ...
    * The script content.
    *
    * @return \AmeliaGuzzleHttp\Psr7\Stream|null The scriptContent
    */
    public function getScriptContent()
    {
        if (array_key_exists("scriptContent", $this->_propDict)) {
            if (is_a($this->_propDict["scriptContent"], "\AmeliaGuzzleHttp\Psr7\Stream") || is_null($this->_propDict["scriptContent"])) {
                return $this->_propDict["scriptContent"];
            } else {
                $this->_propDict["scriptContent"] = \AmeliaGuzzleHttp\Psr7\Utils::streamFor($this->_propDict["scriptContent"]);
                return $this->_propDict["scriptContent"];
            }
        }
        return null;
    ...
    * The script content.
    *
    * @param \AmeliaGuzzleHttp\Psr7\Stream $val The scriptContent
    *
    * @return DeviceCustomAttributeShellScript
    */
