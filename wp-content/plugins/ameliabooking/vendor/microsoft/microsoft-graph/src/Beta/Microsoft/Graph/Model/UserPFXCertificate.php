...
class UserPFXCertificate extends Entity
{
    ...
    * Encrypted PFX blob.
    *
    * @return \AmeliaGuzzleHttp\Psr7\Stream|null The encryptedPfxBlob
    */
    public function getEncryptedPfxBlob()
    {
        if (array_key_exists("encryptedPfxBlob", $this->_propDict)) {
            if (is_a($this->_propDict["encryptedPfxBlob"], "\AmeliaGuzzleHttp\Psr7\Stream") || is_null($this->_propDict["encryptedPfxBlob"])) {
                return $this->_propDict["encryptedPfxBlob"];
            } else {
                $this->_propDict["encryptedPfxBlob"] = \AmeliaGuzzleHttp\Psr7\Utils::streamFor($this->_propDict["encryptedPfxBlob"]);
                return $this->_propDict["encryptedPfxBlob"];
            }
        }
        return null;
    ...
    * Encrypted PFX blob.
    *
    * @param \AmeliaGuzzleHttp\Psr7\Stream $val The encryptedPfxBlob
    *
    * @return UserPFXCertificate
    */
