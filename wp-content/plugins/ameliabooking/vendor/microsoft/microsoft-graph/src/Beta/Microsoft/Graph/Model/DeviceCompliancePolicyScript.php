...
class DeviceCompliancePolicyScript extends Entity
{
    ...
    * Json of the rules.
    *
    * @return \AmeliaGuzzleHttp\Psr7\Stream|null The rulesContent
    */
    public function getRulesContent()
    {
        if (array_key_exists("rulesContent", $this->_propDict)) {
            if (is_a($this->_propDict["rulesContent"], "\AmeliaGuzzleHttp\Psr7\Stream") || is_null($this->_propDict["rulesContent"])) {
                return $this->_propDict["rulesContent"];
            } else {
                $this->_propDict["rulesContent"] = \AmeliaGuzzleHttp\Psr7\Utils::streamFor($this->_propDict["rulesContent"]);
                return $this->_propDict["rulesContent"];
            }
        }
        return null;
    ...
    * Json of the rules.
    *
    * @param \AmeliaGuzzleHttp\Psr7\Stream $val The value to assign to the rulesContent
    *
