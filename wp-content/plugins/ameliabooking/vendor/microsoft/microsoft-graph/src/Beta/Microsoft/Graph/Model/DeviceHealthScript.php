...
class DeviceHealthScript extends Entity
{
    ...
    *
    * @return \AmeliaGuzzleHttp\Psr7\Stream|null The detectionScriptContent
    */
    public function getDetectionScriptContent()
    {
        if (array_key_exists("detectionScriptContent", $this->_propDict)) {
            if (is_a($this->_propDict["detectionScriptContent"], "\AmeliaGuzzleHttp\Psr7\Stream") || is_null($this->_propDict["detectionScriptContent"])) {
                return $this->_propDict["detectionScriptContent"];
            } else {
                $this->_propDict["detectionScriptContent"] = \AmeliaGuzzleHttp\Psr7\Utils::streamFor($this->_propDict["detectionScriptContent"]);
                return $this->_propDict["detectionScriptContent"];
            }
        }
        return null;
    ...
    * The entire content of the detection powershell script
    *
    * @param \AmeliaGuzzleHttp\Psr7\Stream $val The detectionScriptContent
    *
    * @return DeviceHealthScript
    */
    ...
    *
    * @return \AmeliaGuzzleHttp\Psr7\Stream|null The remediationScriptContent
    */
    public function getRemediationScriptContent()
    {
        if (array_key_exists("remediationScriptContent", $this->_propDict)) {
            if (is_a($this->_propDict["remediationScriptContent"], "\AmeliaGuzzleHttp\Psr7\Stream") || is_null($this->_propDict["remediationScriptContent"])) {
                return $this->_propDict["remediationScriptContent"];
            } else {
                $this->_propDict["remediationScriptContent"] = \AmeliaGuzzleHttp\Psr7\Utils::streamFor($this->_propDict["remediationScriptContent"]);
                return $this->_propDict["remediationScriptContent"];
            }
        }
        return null;
    ...
    * The entire content of the remediation powershell script
    *
    * @param \AmeliaGuzzleHttp\Psr7\Stream $val The remediationScriptContent
    *
    * @return DeviceHealthScript
    */
