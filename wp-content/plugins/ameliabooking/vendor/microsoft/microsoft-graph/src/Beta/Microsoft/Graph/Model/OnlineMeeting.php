...
class OnlineMeeting extends Entity
{
    ...
    *
    * @return \AmeliaGuzzleHttp\Psr7\Stream|null The alternativeRecording
    */
    public function getAlternativeRecording()
    {
        if (array_key_exists("alternativeRecording", $this->_propDict)) {
            if (is_a($this->_propDict["alternativeRecording"], "\AmeliaGuzzleHttp\Psr7\Stream") || is_null($this->_propDict["alternativeRecording"])) {
                return $this->_propDict["alternativeRecording"];
            } else {
                $this->_propDict["alternativeRecording"] = \AmeliaGuzzleHttp\Psr7\Utils::streamFor($this->_propDict["alternativeRecording"]);
                return $this->_propDict["alternativeRecording"];
            }
        }
        return null;
    ...
    * The content stream of the alternative recording of a Microsoft Teams live event. Read-only.
    *
    * @param \AmeliaGuzzleHttp\Psr7\Stream $val The alternativeRecording
    *
    * @return OnlineMeeting
    */
    ...
    *
    * @return \AmeliaGuzzleHttp\Psr7\Stream|null The recording
    */
    public function getRecording()
    {
        if (array_key_exists("recording", $this->_propDict)) {
            if (is_a($this->_propDict["recording"], "\AmeliaGuzzleHttp\Psr7\Stream") || is_null($this->_propDict["recording"])) {
                return $this->_propDict["recording"];
            } else {
                $this->_propDict["recording"] = \AmeliaGuzzleHttp\Psr7\Utils::streamFor($this->_propDict["recording"]);
                return $this->_propDict["recording"];
            }
        }
        return null;
    ...
    * The content stream of the recording of a Teams live event. Read-only.
    *
    * @param \AmeliaGuzzleHttp\Psr7\Stream $val The recording
    *
    * @return OnlineMeeting
    */
