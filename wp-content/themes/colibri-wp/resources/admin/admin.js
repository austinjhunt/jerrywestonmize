...
(function ($) {
    ...
    var sleep = function () {
        var _ref = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee(time) {
    ...
    var prepareSiteLeadsPlugin = function () {
        var _ref2 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee8() {
            var onHandleButtonClick = function () {
                        ...
                        while (1) {
                            switch (_context2.prev = _context2.next) {
                                ...
                                case 4:
                                    ...
                                    _context2.next = _context2.t0 === PLUGIN_STATUSES.NOT_INSTALLED ? 8 : _context2.t0 === PLUGIN_STATUSES.INSTALLED ? 11 : 14;
                                    break;
                ...
                return function onHandleButtonClick() {
                    return _ref3.apply(this, arguments);
                };
            }();

            var installAndActivateSiteLeads = function () {
                    ...
                    return _regenerator2.default.wrap(function _callee3$(_context3) {
                        while (1) {
                            switch (_context3.prev = _context3.next) {
                                ...
                                case 3:
                                    installResponse = _context3.sent;
                                ...
                                case 8:
                                    activateResponse = _context3.sent;
                ...
                return function installAndActivateSiteLeads() {
                    return _ref4.apply(this, arguments);
                };
            }();

            var onInstallSiteLeadsPlugin = function () {
                ...
                return function onInstallSiteLeadsPlugin() {
                    return _ref5.apply(this, arguments);
                };
            }();

            var onActivateSiteLeads = function () {
                            ...
                            switch (_context6.prev = _context6.next) {
                                case 0:
                                    ...
                                    promise = new Promise(function () {
                                        var _ref7 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee5(resolve, reject) {
                                            var result;
                ...
                return function onActivateSiteLeads() {
                    return _ref6.apply(this, arguments);
                };
            }();

            var initSetupForSiteLeadsPlugin = function () {
                ...
                return function initSetupForSiteLeadsPlugin() {
                    return _ref8.apply(this, arguments);
                };
            }();

            var globalDataObject, getSiteLeadsBackendData, siteLeadsIntegrationIsEnabled, getTranslatedText, PLUGIN_STATUSES, requestIsPending, currentStatus;
            return _regenerator2.default.wrap(function _callee8$(_context8) {
                while (1) {
                    switch (_context8.prev = _context8.next) {
                        case 0:
                            getTranslatedText = function getTranslatedText(name) {
                                return getSiteLeadsBackendData(['translations', name], name);
                            };

                            getSiteLeadsBackendData = function getSiteLeadsBackendData(path, defaultValue) {
                                return _.get(globalDataObject.siteLeads, path, defaultValue);
                            };

                            globalDataObject = window.colibriwp_builder_status;
        ...
        return function prepareSiteLeadsPlugin() {
    ...
    var processBuilderInstalationStepts = function () {
        var _ref9 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee9(callback) {
        ...
        return function processBuilderInstalationStepts(_x4) {
